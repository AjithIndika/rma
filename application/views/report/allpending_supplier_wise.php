<div  class="container col-sm-12 " style="margin-top:80px"> 
            ...
            <div class="col-md-12 mt-3">
                <div class="card">   
                    <h5 class="mt-4 text-center">All pending job <?php echo $this->db->get_where('supplier', array('supplier_id' => $supplier_id))->row()->supplier_name ?></h5>
                    <table class="table table-head-bg-success table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td>
                                <?php 
                                if(!empty($pending->supplier_send_date_in_note)){
